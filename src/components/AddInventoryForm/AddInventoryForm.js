...
const AddInventoryForm = () => {
    ...
    const [quantityNotInt, setQuanityNotInt] = useState(false);
    ...
    const handleChangeQuantity = (e) => {
        ...
        if (!Number.isInteger(quantityInt)) {
            setQuanityNotInt(true);
        } else {
            setQuanityNotInt(false);
        }
    };
    ...
    return (
        <section className="add-inventory">
            ...
            <form onSubmit={handleSubmit}>
                <div className="add-inventory__details-container">
                    ...
                    <div className="add-inventory__details">
                        ...
                        {inStock && (
                            ...
                            {quantity === "" && hasSubmit && <EmptyField/>}
                            {quantity !== "" && quantityNotInt && hasSubmit && <EmptyField message="Please insert valid number"/>}
                            </div>
                        )}
                ...
                {submitSuccess && (
                <div className="add-inventory__success-message">Successfully added new video. Redirecting you to view videos!</div>
            )}
            </form>
        </section>
    );
