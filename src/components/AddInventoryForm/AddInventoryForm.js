                    ...
                    <div className="add-inventory__details">
                        ...
                        <div className="add-inventory__form-radio-container">
                            <div className="add-inventory__form-radio-item">
                                <input className="add-inventory__form-input add-inventory__form-input--status" id="in-stock" type="radio" name="status" value="In Stock"  checked={inStock} onChange={() => setInStock(true)} />
                                <label htmlFor="in-stock" className="add-inventory__form-label add-inventory__form-label--status">In stock</label>
                            </div>
                            <div className="add-inventory__form-radio-item">
                                <input className="add-inventory__form-input add-inventory__form-input--status" id="out-of-stock" type="radio" name="status" value="Out of Stock" checked={!inStock} onChange={() => setInStock(false)} />
                        ...
                        {(quantityEmpty || (quantityEmpty && statusEmpty)) && (<EmptyField />)}
